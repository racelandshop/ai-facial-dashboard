      ...
      >
        ...
        <div class="container">
                      ...
                      <div>
                        ...
                        ${area
                          ? html`
                              ...
                              >
                            `
                          : html`<p @click=${this._showSettings} id="add-area">
                              ${this.hass.localize(
                                "ui.panel.config.devices.add_area"
                              )}
                            </p>`}
                      </div>
                      <ha-icon-button
          ...
          <div class="column">
            ...
            ${
              isComponentLoaded(this.hass, "scene") && entities.length && false
                ? html`
                    <ha-card>
                      <h1 class="card-header">
                        ${this.hass.localize(
              ...
              ${
                isComponentLoaded(this.hass, "script") && false
                  ? html`
                      <ha-card>
                        <h1 class="card-header">
                          ${this.hass.localize(
