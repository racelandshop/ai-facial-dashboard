...
class HuiWeatherForecastCard extends LitElement implements LovelaceCard {
  ...
  @state() private _cardSize?: string = "big";
    ...
    return html`
      <ha-card
        class=${classMap({
          ...
          "ha-card-medium": this.layout === "medium",
          "ha-card": this.layout === "big",
        })}
        ...
        ${weather
          ? html`
              <div class="content">
                <div
                  class=${classMap({
                    "icon-image-small": this.layout === "small",
                    "icon-image-medium": this.layout === "medium",
                    "icon-image": this.layout === "big",
                  })}
                >
                  ${weatherStateIcon ||
                  html`
                ...
                <div class="info">
                  <div
                    class=${classMap({
                      "name-state-medium": this.layout === "medium",
                      "name-state": this.layout === "big",
                    })}
                  >
                    ${this.layout === "big"
                      ? html`<div class="state-big">
                            ${computeStateDisplay(
                              this.hass.localize,
                              stateObj,
                              this.hass.locale
                  ...
                  <div class="temp-attribute">
                    <div
                      class=${classMap({
                        "temp-small": this.layout === "small",
                        "temp-medium": this.layout === "medium",
                        temp: this.layout === "big",
                      })}
                    >
                      ${formatNumber(
