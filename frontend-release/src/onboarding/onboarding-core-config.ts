...
const lisbon: [number, number] = [38.7071, -9.13549];
...
class OnboardingCoreConfig extends LitElement {
  ...
  protected firstUpdated(changedProps) {
    ...
    const tzInput = this.shadowRoot!.querySelector("[name=timeZone]") as any;
    tzInput.inputElement.appendChild(createTimezoneListEl());

    const cInput = this.shadowRoot!.querySelector("[name=currency]") as any;
