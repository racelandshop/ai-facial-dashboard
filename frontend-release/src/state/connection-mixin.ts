...
// import { fetchThemeUserData } from "../data/frontend";
...
export const connectionMixin = <T extends Constructor<HassBaseEl>>(
  ...
  class extends superClass {
    protected initializeHass(auth: Auth, conn: Connection) {
      ...
      // const theme = await fetchThemeUserData(conn, "language"); // the second argument is to ensure backwards comparibility with a similar function ("fetchFrontendUserData") and with the backend function
