...
const SHOW_AFTER_SPACER = [
  "automation-redirect-panel",
  "integration-redirect-panel",
  "config",
  "developer-tools",
  "alarmo",
];
...
const SORT_VALUE_URL_PATHS = {
  ...
  "developer-tools": 9,
  config: 13,
  "automation-redirect-panel": 10,
  "integration-redirect-panel": 11,
  alarmo: 12,
};
  ...
  private _renderHeader() {
    ...
    >
      ...
      ${this.editMode
        ...
        : html`<div class="title">Homeland</div>`}
    </div>`;
  }
    ...
    return [
      ...
      css`
        ...
        .iron-selected paper-icon-item::before {
          ...
          opacity: 0; /** podemos dar uma variavel se quisermos */
        }
        a:not(.iron-selected):focus::before {
        ...
        .iron-selected paper-icon-item[pressed]:before {
          ...
          ); /** podemos dar uma variavel se quisermos */
        }
        ...
        a:not(.iron-selected):hover > .notifications {
